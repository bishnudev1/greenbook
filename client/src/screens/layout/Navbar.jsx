...
const Navbar = () => {
    ...
    return (
        <Box className={isScrolled ? 'navbar-blur' : ''} style={{
            "position": "sticky",
            "zIndex": 11,
            "top": 0
        }} bgColor={'transparent'} color={'white'} p={'4'}>
            <Stack spacing={'8'} direction={["column", "row"]} justifyContent={["center", "space-around"]} alignItems={'center'}>
                ...
                <HStack width={["100%", "unset"]} justifyContent={["space-evenly", "unset"]} spacing={'7'}>
                    ...
                    <Link to={'/register'}>                    <Button _hover={{ "color": "green" }} fontFamily={"heading"} fontSize={["sm", "md"]} size={["sm", "md"]} variant={'link'} colorScheme='white'>Create Account</Button></Link>
                    <Link to='/greenblogs'>
